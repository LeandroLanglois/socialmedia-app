...
routes.delete("/post/:postId/dislike", authMiddleware, UserController.removeLikeDislike)
routes.get("/posts/user-reactions", authMiddleware, UserController.getUserReactions)
